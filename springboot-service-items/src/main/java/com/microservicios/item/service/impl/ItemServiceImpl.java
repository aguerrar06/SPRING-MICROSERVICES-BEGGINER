...
public class ItemServiceImpl implements ItemService {
	...
	public List<Item> findAll() {
		List<Producto> productos = Arrays.asList(this.clienteRest.getForObject("http://localhost:8001/listar", Producto[].class));
	...
	public Item ver(Long id, Integer cantidad) {
		...
		Producto producto = this.clienteRest.getForObject("http://localhost:8001/ver/{id}", Producto.class, pathVariables);
